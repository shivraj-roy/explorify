   ...
   return (
      <>
         <nav className="flex items-center justify-center fixed bottom-12 md:bottom-8 left-1/2 transform -translate-x-1/2 z-10">
            <div className="flex justify-center items-center w-[330] md:w-[500px] p-4 gap-15 md:gap-20 h-16 rounded-3xl bg-dark/30 backdrop-blur-xl border-[0.1px] border-white/50 shadow-md">
